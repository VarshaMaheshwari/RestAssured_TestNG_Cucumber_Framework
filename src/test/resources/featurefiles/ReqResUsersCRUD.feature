Feature: User API CRUD operation validations
  ...
  link to API documentation: https://reqres.in/api-docs/#/default/get_users
  ...
  Scenario Outline: Verify Get all users API works as expected
    ...
    And Response body contains data as per expected values <data_size>

    Examples:
      | Description             | page | per_page | total | total_pages | data_size |
      | Page 1 with 4 per page  | 1    | 4        | 12    | 3           | 4         |
      | Page 2 with 10 per page | 2    | 10       | 12    | 2           | 2         |
      | Default page 1          |      | 4        | 12    | 3           | 4         |
      | Default per_page 6      | 3    |          | 12    | 2           | 0         |
